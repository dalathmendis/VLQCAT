...
if h_data in templates:
    ...
    h_data.SetName("eeT0Z0H0b2H0b2__DATA")
    h_data.Write("")
                                                 

if h_dy in templates:
        
    h_dy.SetName("mumuT0Z0H0b2__DY")
    h_dy.Write("")
        
if h_diboson in templates:
            
    h_diboson.SetName("mumuT0Z0H0b2__VV")
    h_diboson.Write("")
            
if h_top in templates:                                                                                                                                                                        
        
    h_top.SetName("mumuT0Z0H0b2__Top")                                                                                                                                                               
    h_top.Write("")    


if h_tZtZ_800 in templates:

    h_tZtZ_800.SetName("mumuT0Z0H0b2__TT_tZtZ_M800")
    h_tZtZ_800.Write("")

if h_tZtH_800 in templates:

    h_tZtH_800.SetName("mumuT0Z0H0b2__TT_tZtH_M800")
    h_tZtH_800.Write("")

if h_tZbW_800 in templates:

    h_tZbW_800.SetName("mumuT0Z0H0b2__TT_tZbW_M800")
    h_tZbW_800.Write("")

if h_tZtZ_1000 in templates:

    h_tZtZ_1000.SetName("mumuT0Z0H0b2__TT_tZtZ_M1000")
    h_tZtZ_1000.Write("")

if h_tZtH_1000 in templates:

    h_tZtH_1000.SetName("mumuT0Z0H0b2__TT_tZtH_M1000")
    h_tZtH_1000.Write("")

if h_tZbW_1000 in templates:

    h_tZbW_1000.SetName("mumuT0Z0H0b2__TT_tZbW_M1000")
    h_tZbW_1000.Write("")

if h_tZtZ_1200 in templates:
        
    h_tZtZ_1200.SetName("mumuT0Z0H0b2__TT_tZtZ_M1200")
    h_tZtZ_1200.Write("")

if h_tZtH_1200 in templates:

    h_tZtH_1200.SetName("mumuT0Z0H0b2__TT_tZtH_M1200")
    h_tZtH_1200.Write("")

if h_tZbW_1200 in templates:
    
    h_tZbW_1200.SetName("mumuT0Z0H0b2__TT_tZbW_M1200")
    h_tZbW_1200.Write("")
...
ll.SetTextSize(0.05)
if len(data)>0:
    ll.DrawLatex(0.78,0.92, "35.9 fb^{-1} (13 TeV)");#2.2 0r 0.53
else:
